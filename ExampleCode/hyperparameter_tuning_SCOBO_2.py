# we want to figure out optimal values for s_exact & r in the SCOBO algorithm.
...
# choose 3 problems.
# write code to run SCOBO and increment s_exact and r (in two nested FOR loops).
# run SCOBO for this problem with all combinations (16) of s_exact={10, 20, 50, 100} & r={0.001, 0.01, 0.1, 1}.
...
for i in range(4):
    ...
    for j in range(4):
        ...
        scobo1 = SCOBOoptimizer(oracle_scobo, step_size, query_budget, x0_scobo, r, m_scobo, s_exact, objfunc=p.obj)
        # step.
        termination = False
        prev_evals = 0
        while termination is False:
